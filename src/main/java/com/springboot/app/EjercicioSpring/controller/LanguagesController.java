...
public class LanguagesController {
	...
	@GetMapping("/actualizarlanguage")
	public ResponseEntity<Languages> updateLanguages(@PathVariable long id, @RequestBody Languages language){
		language.setId((int) id);
		return ResponseEntity.ok().body(languageService.createLanguages(language));
	}
